...
from auto_LiRPA.perturbations import PerturbationLpNormWithRegion
...
lirpa_model = BoundedModule(model, torch.empty_like(image), device=image.device, bound_opts={"conv_mode": "matrix"})
...
for method in [
        'IBP',  ' IBP+backward','backward (CROWN)',
