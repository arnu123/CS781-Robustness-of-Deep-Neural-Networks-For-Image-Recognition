...
from auto_LiRPA import BoundedModule, BoundedTensor, PerturbationLpNorm, PerturbationLpNormWithRegion
...
ptb = PerturbationLpNormWithRegion(norm=args.norm, eps=args.eps)
